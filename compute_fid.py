...
def get_fid_for_dir_path(path_name, start_epoch, end_epoch, iter_step, stats_path, dataset_name, model_name, if_nvae=False):
...
if __name__ == "__main__":
    ...
    get_fid_for_dir_path(args.images_path, args.start_epoch, args.end_epoch, args.epoch_step, args.stats_path, args.dataset_name, args.model_name)